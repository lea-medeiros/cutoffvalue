...
par(mar=c(5,6,4,1)+.1)
hist(mydata, breaks = 15, density = 10, col = "grey", xaxt="n", xlab = "Plasma [11-KT] (ng/mL)",
     ylim = c(0, ylim.upper), xlim = c(xlim.lower, xlim.upper), main = " ", cex.lab=2, cex.axis=1.5,
     family = "Times")
...
text(cutoff+(step/2),ylim.upper-5, adj = c(0, 1), paste("Minijack cutoff", "\n =", round(10^(cutoff), 2),
      "(ng/mL)" ), cex=1.5, family = "Times", font = 2)
